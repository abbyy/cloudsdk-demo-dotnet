...
{
	[Command(CommandConsts.Process.ProcessImageCommand.Name, Description = CommandConsts.Process.ProcessImageCommand.Description)]
	internal sealed class ProcessImageCommand : SourceFileCommand
	{
		...
		public ProcessImageCommand(IProcessRunnerService processRunnerService) : base(processRunnerService, Mode.Image)
		{
		}
